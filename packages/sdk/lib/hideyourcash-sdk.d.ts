...
export declare const getPublicArgs: (proof: any, relayer: RelayerDataInterface, publicSignals: any, recipient: string) => PublicArgsInterface;
...
export declare class HideyourCash extends Actions {
	...
	constructor(network: string, nodeUrl: string, contract: string, graphqlUrl: string, connection: WalletSelector);
}

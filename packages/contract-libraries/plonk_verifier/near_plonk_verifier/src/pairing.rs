...
#[derive(Serialize, Deserialize, BorshSerialize, BorshDeserialize, Clone, Debug, Default, Copy)]
...
#[derive(Serialize, Deserialize, BorshSerialize, BorshDeserialize, Clone, Default, Copy)]
#[serde(crate = "near_sdk::serde")]
pub struct G2Point {
    pub x: [U256; 2],
    pub y: [U256; 2],
